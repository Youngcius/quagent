...
from PyQt5.QtWidgets import (QLineEdit, QWidget, QGroupBox, QCheckBox, QGridLayout, QPushButton, QApplication, QHBoxLayout, QLabel, QComboBox, QStyleFactory, QSizePolicy)
...
class basicWindow(QWidget):
    ...
    def createMainGroupBox(self):
        ...
        str_ports_com2 = ['ECE SNSPD 2','CWDM 1',"Ivan's Lab",'04','05','06','07','08','09','10','11','12','13','14','15','16']
        str_ports_com3 = ['ECE SNSPD 3','CWDM 2','03','04','05','06','07','08','09','10','11','12','13','14','15','16']
        str_ports_com4 = ['ECE SNSPD 4','CWDM 2','03','04','05','06','07','08','09','10','11','12','13','14','15','16']
        str_ports_com5 = ['ECE SNSPD 5','OSC SNSPD 3','03','04','05','06','07','08','09','10','11','12','13','14','15','16']
    ...
    def set_dropdown(self):
        ...
        if connection:
            ...
            connections = [self.com1_dict[self.cur_cp1],self.com2_dict[self.cur_cp2],self.com3_dict[self.cur_cp3],self.com4_dict[self.cur_cp4],self.com5_dict[self.cur_cp5]]
